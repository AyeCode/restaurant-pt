        ...
        <?php if (is_single() || is_page()): ?>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12">
                        <section class="blog-item-featured-image">
                            ...
                            $image_src = wp_get_attachment_image_src($attachment_id, 'restaurant-pt-boxed-12');
                            if ( ! empty( $image_src[0] ) ) :
                            echo '<img src="' . $image_src[0] . '" alt="' . esc_attr(__('featured image', 'restaurant-pt')) . '" width="' . $image_src[1] . '" height="' . $image_src[2] . '" />';
                            endif; 
                          ?>
                        </section>
                    </div>
            ...
            <div class="col-lg-8">
                ...
                <?php if (is_home() || is_category() || is_tag() || is_search() || is_archive()): // is the blog index? ?>
                        ...
                        <section id="cb-blog-container">
                            <?php while (have_posts()):the_post(); ?>
                                <article id="<?php the_ID(); ?>" class="blog-item">
                                    ...
                                    <a class="blog-item-read-more rpt_logo_upload" title="<?php the_title_attribute(); ?>" href="<?php the_permalink(); ?>">
                                        <?php echo __('READ MORE', 'restaurant-pt'); ?>
                                    </a>
                                    <hr/>
                                </article>
                            <?php endwhile; ?>

                            <?php if(restaurant_pt_pagination() != false): ?>
                                <section class="pagination">
                                    <?php restaurant_pt_pagination(); ?>
                                </section>
                            <?php endif; ?>
                    ...
                    <?php else: ?>
                        <p><?php echo __('There are not any posts available' . 'restaurant-pt'); ?></p>
                    <?php endif; ?>
